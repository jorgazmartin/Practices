...
cat("**** START OF JOB DS2_01_Annotated_Data ****\n")
rm(list = ls())
...
if (Validation(genes_fly, lengths, metadata, reads, tpms)) {
  ...
  write.table(tpms,"Analyses/Inputs/Processed_datasets/D2/annotated/tximport_tpms.txt")
  write.table(metadata,"Analyses/Inputs/Processed_datasets/D2/annotated/metadata.txt")
  
  cat("**** END OF JOB DS2_01_Annotated_Data ****\n")
